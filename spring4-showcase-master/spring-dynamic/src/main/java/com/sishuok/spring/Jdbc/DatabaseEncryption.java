...
public class DatabaseEncryption {
    ...
    private static String ENCRYPT = "DES";
    ...
    private static Key getKey(byte[] arrBTmp) throws Exception {
        ...
        Key key = new SecretKeySpec(arrB, ENCRYPT);
        return key;
    }
    ...
    static {
        ...
        try {
            ...
            encryptCipher = Cipher.getInstance(ENCRYPT);
            encryptCipher.init(1, key);
            decryptCipher = Cipher.getInstance(ENCRYPT);
